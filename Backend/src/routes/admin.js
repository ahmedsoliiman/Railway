...
router.post(
  '/carriages',
  [
    body('carriageNumber').trim().notEmpty().withMessage('Carriage number is required'),
    body('carriage_number').optional().trim().notEmpty().withMessage('Carriage number is required'),
    body('carriageTypeId').isInt().withMessage('Carriage type ID is required'),
    body('carriage_type_id').optional().isInt().withMessage('Carriage type ID is required'),
  ],
  validate,
...
router.post(
  '/trips',
  [
    body('train_id').optional().isInt(),
    body('trainId').optional().isInt(),
    body('origin_station_id').optional().isInt(),
    body('originStationId').optional().isInt(),
    body('destination_station_id').optional().isInt(),
    body('destinationStationId').optional().isInt(),
    body('departure').optional().isISO8601(),
    ...
    body('first_class_price').optional().isFloat({ min: 0 }),
    body('firstClassPrice').optional().isFloat({ min: 0 }),
    body('second_class_price').optional().isFloat({ min: 0 }),
    body('secondClassPrice').optional().isFloat({ min: 0 }),
    body('economic_price').optional().isFloat({ min: 0 }),
    body('economicPrice').optional().isFloat({ min: 0 }),
    body('quantities').optional().isInt({ min: 1 }),
  ],
